...
# exports 122
export CODEX_APP_TOOLS_PIPE_PATH=/tmp/codex-browser-use/c6e35998-5573-4767-a91a-6316a0a2a262.sock
export CODEX_CI=1
export CODEX_HOME='/Users/hitsz/equipment research/outputs/runtime/codex-homes/swarm-queen-20260909-v3-auditor'
...
export CODEX_SESSION_ID=01a085dc-f3e8-7032-9e80-2e85a304ed8e
...
export EQUIPMENT_DR_CODEX_QUEEN_MODEL=qwen3.8-flash
...
export EQUIPMENT_DR_MODEL=qwen3.8-flash
export EQUIPMENT_DR_MODEL_PROGRESS_INTERVAL_SECONDS=15
export EQUIPMENT_DR_PROVIDER=codex_queen
...
export EQUIPMENT_DR_S6_CODEX_CONCURRENCY=32
export EQUIPMENT_DR_S6_HARD_TIMEOUTS=0
export EQUIPMENT_DR_S6_MODEL_CONCURRENCY_MAX=32
...
export PAGER=cat
export -T PATH path=( /usr/local/bin /System/Cryptexes/App/usr/bin /usr/bin /bin /usr/sbin /sbin /var/run/com.apple.security.cryptexd/codex.system/bootstrap/usr/local/bin /var/run/com.apple.security.cryptexd/codex.system/bootstrap/usr/bin /var/run/com.apple.security.cryptexd/codex.system/bootstrap/usr/appleinternal/bin /pkg/env/global/bin /opt/homebrew/bin '/Users/hitsz/equipment research/outputs/runtime/codex-homes/swarm-queen-20260909-v3-auditor/tmp/arg0/codex-arg0yCjPky' /opt/homebrew/lib/node_modules/@openai/codex/node_modules/@openai/codex-darwin-arm64/vendor/aarch64-apple-darwin/codex-path /Users/hitsz/.codex/tmp/arg0/codex-arg0De2upr /Users/hitsz/.cache/codex-runtimes/codex-primary-runtime/dependencies/bin/override /Users/hitsz/.cache/codex-runtimes/codex-primary-runtime/dependencies/bin/fallback /Applications/ChatGPT.app/Contents/Resources )
