...
export CODEX_CI=1
export CODEX_HOME='/Users/hitsz/equipment research/outputs/runtime/codex-homes/run-28a001ce-9200-4844-8d2b-771eef9a55ea-auditor'
...
export EQUIPMENT_DR_BUILD_HASH=75f18fe6b0ff
...
export EQUIPMENT_DR_FALLBACK_POLICY=capacity_only
export EQUIPMENT_DR_FALLBACK_PROFILES=codex
...
export PAGER=cat
export -T PATH path=( /usr/local/bin /System/Cryptexes/App/usr/bin /usr/bin /bin /usr/sbin /sbin /var/run/com.apple.security.cryptexd/codex.system/bootstrap/usr/local/bin /var/run/com.apple.security.cryptexd/codex.system/bootstrap/usr/bin /var/run/com.apple.security.cryptexd/codex.system/bootstrap/usr/appleinternal/bin /pkg/env/global/bin /opt/homebrew/bin '/Users/hitsz/equipment research/outputs/runtime/codex-homes/run-28a001ce-9200-4844-8d2b-771eef9a55ea-auditor/tmp/arg0/codex-arg0vWx7re' /opt/homebrew/lib/node_modules/@openai/codex/node_modules/@openai/codex-darwin-arm64/vendor/aarch64-apple-darwin/codex-path /Users/hitsz/.codex/tmp/arg0/codex-arg064MPrG /Users/hitsz/.cache/codex-runtimes/codex-primary-runtime/dependencies/bin/override /Users/hitsz/.cache/codex-runtimes/codex-primary-runtime/dependencies/bin/fallback /Applications/ChatGPT.app/Contents/Resources )
