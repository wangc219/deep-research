...
export CODEX_CI=1
export CODEX_HOME='/Users/wangchen/equipment research/outputs/evals/ablations/ablation-20260729-142922/systems/no_multisource_baseline/Q-0008/runtime/runtime/reporter-agent-workspace/outputs/runtime/codex-homes/reporter'
export CODEX_MANAGED_BY_NPM=1
export CODEX_MANAGED_PACKAGE_ROOT=/Users/wangchen/.local/lib/node_modules/@openai/codex
...
export EQUIPMENT_DR_AGENT_MODELS_JSON='{"orchestrator":{"model":"gpt-5.4"},"scenario_divergence":{"model":"gpt-5.4"},"convergence_fusion":{"model":"gpt-5.4"},"reporter":{"model":"gpt-5.5"}}'
export EQUIPMENT_DR_ALLOW_BENCHMARK_DNS_PROXY=1
export EQUIPMENT_DR_ALLOW_LIMITED_BASELINE=1
export EQUIPMENT_DR_APP_DB='sqlite:////Users/wangchen/equipment research/outputs/application.db'
...
export EQUIPMENT_DR_ENV_FILE='/Users/wangchen/equipment research/.env.codex'
...
export EQUIPMENT_DR_PROJECT_ROOT='/Users/wangchen/equipment research'
...
export EQUIPMENT_DR_RESEARCH_WORKER_CONCURRENCY=4
export EQUIPMENT_DR_SOURCE_PRIORITY_INDEX=outputs/knowledge/source-priority-index.json
export EQUIPMENT_DR__API_KEY=sk-NJKZWTYnGSE3bf69M
export EQUIPMENT_EVAL_DASHSCOPE_API_KEY=''
export EQUIPMENT_EVAL_DASHSCOPE_BASE_URL='https://<WorkspaceId>.cn-beijing.maas.aliyuncs.com/api/v1'
export EQUIPMENT_EVAL_OPENAI_API_KEY=sk-NJKZWTYnGSE3bf69M
export EQUIPMENT_EVAL_OPENAI_BASE_URL=https://codexpro.wwxb1123.xyz/v1
export EQUIPMENT_EVAL_ZHIPU_API_KEY=sk-49aZKO2yUS9NnU4OP3IHTE5NoY3oSeaL5P7XKmSkpA2d6E51
export EQUIPMENT_EVAL_ZHIPU_BASE_URL=https://yunwu.ai/v1
export GH_PAGER=cat
export GIT_PAGER=cat
export GSETTINGS_SCHEMA_DIR=/opt/anaconda3/share/glib-2.0/schemas
export GSETTINGS_SCHEMA_DIR_CONDA_BACKUP=''
export HOME=/Users/wangchen
export JAVA_HOME=/opt/homebrew/opt/openjdk@21/libexec/openjdk.jdk/Contents/Home
export LANG=C.UTF-8
export LC_ALL=C.UTF-8
export LC_CTYPE=C.UTF-8
export LOGNAME=wangchen
export LOG_FORMAT=json
export MallocNanoZone=0
export NODE_REPL_TRUSTED_BROWSER_CLIENT_SHA256S=6d25aa7656feac858f3a3bdaea5bcbab0dbfd426c9de8e6931ce90c399ee8e4f,e13fd947e846d3d306e9249dd3c73d14931b6494803dbafb16cef85e6add9506
export NODE_REPL_TRUSTED_CODE_PATHS=/Users/wangchen/.codex
export NO_COLOR=1
export NVM_CD_FLAGS=-q
export NVM_DIR=/Users/wangchen/.nvm
export NVM_RC_VERSION=''
export OPENAI_API_KEY=sk-NJKZWTYnGSE3bf69M
export OSLogRateLimit=64
export PAGER=cat
export PTCA_LLM_DEEPSEEK_API_KEY=sk-XAuX5YVbLy5U7vZDMXIPNYlxDDg6snZYPbCOZgRcodaBz8eV
export PTCA_LLM_DEEPSEEK_MODEL=deepseek-v4-pro
export PTCA_LLM_DEEPSEEK_URL=https://ai.kegeai.top/v1
export PTCA_LLM_GPT55_API_KEY=sk-KDmldZihuJyNegMi5DWb8YIaepeI3mBTchZtL5FlhHxkmGtV
export PTCA_LLM_GPT55_MODEL=gpt-5.5
export PTCA_LLM_GPT55_URL=https://ai.kegeai.top/v1
export PTCA_LLM_QWEN3_API_KEY=sk-EfEMC1j79rraDGbXKTJvBA76H92t0vaNsSGMV8DsdqM9k4UY
export PTCA_LLM_QWEN3_MODEL=qwen3.7-plus
export PTCA_LLM_QWEN3_URL=https://ai.kegeai.top/v1
export PYTHONPATH=':/Users/wangchen/equipment research/src'
export RUST_LOG=warn
export SHELL=/bin/zsh
export SSH_AUTH_SOCK=/var/run/com.apple.launchd.1xRACGsZZ7/Listeners
export TERM=dumb
export TMPDIR=/var/folders/gr/vcc9p6yn77z1kvhs8kz7qrbm0000gn/T/
export USER=wangchen
