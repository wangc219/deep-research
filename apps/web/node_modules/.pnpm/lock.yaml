...
importers:
  ...
  .:
    dependencies:
      '@vitejs/plugin-react':
        specifier: latest
        version: 6.1.1(vite@8.2.2(@types/node@25.9.5))
      buffer:
        specifier: ^6.0.3
        version: 6.0.3
      docx:
      ...
      vite:
        specifier: latest
        version: 8.2.2(@types/node@25.9.5)
...
snapshots:
  ...
  '@vitejs/plugin-react@6.1.1(vite@8.2.2(@types/node@25.9.5))':
    dependencies:
      '@rolldown/pluginutils': 1.0.1
      vite: 8.2.2(@types/node@25.9.5)
