...
class DeepResearchRunner:
    ...
    def _run_discovery_convergence(
        ...
        *,
        ...
        optimized_v2 = discovery_blueprint.get("execution_profile_id") == "optimized_v2"
        material_conflicts = [
            limitation
    ...
    def _write_outputs(
        ...
        *,
        ...
        if discovery_blueprint.get("execution_profile_id") == "optimized_v2":
