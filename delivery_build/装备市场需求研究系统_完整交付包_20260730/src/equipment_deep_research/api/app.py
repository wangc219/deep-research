...
class CreateRunBody(BaseModel):
    ...
    execution_profile_id: str = "optimized_v2"
...
def create_app(
    ...
    *,
    ...
    def create_run(body: CreateRunBody, x_role: str = Header(default="analyst", alias="X-Role")) -> dict:
        ...
        if body.execution_profile_id not in {"", "legacy_v1", "optimized_v2"}:
...
def _interaction_workflow_summary(rows: list[dict], view: object) -> dict:
    ...
    for row in rows:
        ...
        if (
            ...
            if dynamic_agent_id:
                dynamic_agents_by_id[dynamic_agent_id] = {
    ...
    dynamic_agents = list(dynamic_agents_by_id.values())
    skipped_agent_ids = {
