...
在现有多智能体 Deep Research 架构上增加企业级服务端与 Web 研究工作台，使系统不仅能够通过 CLI 跑通算法闭环，还能面向分析师、评审人员、审计人员和系统管理员提供统一、可视、可控、可追溯的业务系统。
...
| 项目验收 | PostgreSQL | Redis | 本地持久卷 | 本地账号或 OIDC |
...
- OIDC/OAuth2 接入目标环境统一身份，验收环境可使用本地账号适配器。
