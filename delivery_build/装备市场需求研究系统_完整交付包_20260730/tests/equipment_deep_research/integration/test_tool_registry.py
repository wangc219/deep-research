...
def test_four_way_tool_allowlist_uses_agent_task_active_skills_and_phase() -> None:
    assert effective_tool_names(
        agent_allowlist=["search_sources", "fetch_page", "compare_coa"],
        task_allowlist=["search_sources", "compare_coa"],
        skill_allowlists=[
            ["search_sources", "fetch_page"],
            ["compare_coa"],
        ],
        phase_allowlist=["search_sources", "fetch_page", "compare_coa"],
    ) == ("search_sources", "compare_coa")
